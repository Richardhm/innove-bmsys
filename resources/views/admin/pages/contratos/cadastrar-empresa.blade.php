            ...
            <div style="display:flex;flex-basis:10%;">
                <div>
                    <div class="form-group">
                            ...
                            <input type="text" name="desconto_operadora" required id="desconto_operadora" value="" class="form-control form-control-sm" placeholder="Desconto Operadora">
                    </div>
                </div>
                 <div style="flex-basis:15%;margin-left:1%;">
	                    <div>
	                        <span for="quantidade_parcelas" class="text-white" style="font-size:0.875em;">Quantidade Parcelas do desconto:</span>
	                        <select name="quantidade_parcelas" id="quantidade_parcelas" class="form-control form-control-sm">
