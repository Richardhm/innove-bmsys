        ...
        @for($i=0;$i < count($dados); $i++)
            ...
            @if($dados[$i]->card == $card_inicial)
                @if($ii==0)
                    ...
                    <div class="d-flex flex-column rounded valores-acomodacao mb-3 py-2 border border-dark" data-acomodacao="{{$dados[$i]->acomodacao}}"  style="width:32%;color:white;background-color:#C5D4EB;color:black;">
