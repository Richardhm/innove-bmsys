...
@php
    ...
    @for($i=0;$i < count($administradoras);$i++)       
        ...
        @if($administradoras[$i]->nome == $administradora)
            ...
            @if($ii==1)
                <div class="col-2 d-flex justify-content-between p-1 container_tabela mb-2" style="border:3px solid #0dcaf0;border-radius:5px;background-color:#123449;color:#fff;margin-right:1%;box-shadow: 5px 0 8px rgb(65,105,225);">
