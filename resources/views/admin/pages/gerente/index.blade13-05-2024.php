...
@section('content')
    ...
    <ul class="list_abas" style="margin-top:1px;">
        ...
        <li data-id="aba_comissao" class="menu-inativo ativo_menu">Comissão</li>
                   ...
                   <div style="background-color: #123449;margin-top:2px;margin-bottom:2px;">
                       ...
                       <ul style="margin:0 0 0 0;padding:0;">
                           ...
                           <li style="display:flex;justify-content: space-between;" data-plano="1" id="listar_individual_apto_total">
                               <span style="display:flex;flex-basis:50%;font-size:0.68em;margin-left:2px;color:#FFF;">Individual</span>
                               <span style="display:flex;flex-basis:10%;font-size:0.68em;color:#FFF;" id="total_quantidade_individual_total">{{$total_individual_quantidade}}</span>
                               <span style="display:flex;flex-basis:40%;justify-content:flex-end;font-size:0.68em;margin-right:2px;color:#FFF;"><span id="valor_total_individual_total">{{$total_individual}}</span></span>
                           </li>

                           <li style="display:flex;justify-content: space-between;" data-plano="3" id="listar_coletivo_apto_total">
                               <span style="display:flex;flex-basis:50%;font-size:0.68em;margin-left:2px;color:#FFF;">Coletivo</span>
                               <span style="display:flex;flex-basis:10%;font-size:0.68em;color:#FFF;" id="total_quantidade_coletivo_total">{{$total_coletivo_quantidade}}</span>
                               <span style="display:flex;flex-basis:40%;justify-content:flex-end;font-size:0.68em;margin-right:2px;color:#FFF;"><span id="valor_total_coletivo_total">{{$total_coletivo}}</span></span>
                           </li>

                           <li style="display:flex;justify-content: space-between;" data-plano="0" id="listar_empresarial_apto_total">
                               <span style="display:flex;flex-basis:50%;font-size:0.68em;margin-left:2px;color:#FFF;">Empresarial</span>
                               <span style="display:flex;flex-basis:10%;font-size:0.68em;color:#FFF;" id="total_quantidade_empresarial_total">{{$total_empresarial_quantidade}}</span>
                               <span style="display:flex;flex-basis:40%;justify-content:flex-end;font-size:0.68em;margin-right:2px;color:#FFF;"><span id="valor_total_empresarial_total">{{$total_empresarial}}</span></span>
                           </li>
               ...
               <section style="flex-basis:47%;margin-right: 1%;">
                   ...
                   <div style="background-color: #123449;margin-top:2px;">
                       ...
                       <ul style="margin:0 0 0 0;padding:0;" id="lista_apto_a_pagar_ul">
                           <li style="display:flex;justify-content: space-between;" id="listar_individual_apto">
                               <span style="display:flex;flex-basis:60%;font-size:0.68em;margin-left:2px;color:#FFF;">Individual</span>
                               <span style="display:flex;flex-basis:10%;font-size:0.68em;color:#FFF;" id="total_quantidade_individual">0</span>
                               <span style="display:flex;flex-basis:30%;justify-content:flex-end;font-size:0.68em;margin-right:2px;color:#FFF;"><span id="valor_total_individual">0</span></span>
                           </li>
                           <li style="display:flex;justify-content: space-between;" id="listar_coletivo_apto">
                               <span style="display:flex;flex-basis:60%;font-size:0.68em;margin-left:2px;color:#FFF;">Coletivo</span>
                               <span style="display:flex;flex-basis:10%;font-size:0.68em;color:#FFF;" id="total_quantidade_coletivo">0</span>
                               <span style="display:flex;flex-basis:30%;justify-content:flex-end;font-size:0.68em;margin-right:2px;color:#FFF;"><span id="valor_total_coletivo">0</span></span>
                           </li>
                           <li style="display:flex;justify-content: space-between;" id="listar_empresarial_apto">
                               <span style="display:flex;flex-basis:60%;font-size:0.68em;margin-left:2px;color:#FFF;">Empresarial</span>
                               <span style="display:flex;flex-basis:10%;font-size:0.68em;color:#FFF;" id="total_quantidade_empresarial">0</span>
                               <span style="display:flex;flex-basis:30%;justify-content: flex-end;font-size:0.68em;margin-right:2px;color:#FFF;"><span id="valor_total_empresarial">0</span></span>
                           </li>
                       </ul>
                   </div>
                   ...
                   <!-- <div style="background-color:#123449;border-radius:5px;margin:2px 0;">
                       ...
                       <ul style="margin:0 0 0 0;list-style:none;padding:0;" class="listar">
                           <li style="font-size:0.68em;display:flex;margin-left:2px;justify-content: space-between;align-items:center;" class="individual_recebidas ativo">
                                <span>Individual</span>
                                <span class="valores_em_destaque">0</span>
                            </li>
                           <li style="font-size:0.68em;color:#FFF;margin-left:2px;display:flex;justify-content: space-between;align-items:center;" class="coletivo_recebidas">
                               <span>Coletivo</span>
                               <span class="valores_em_destaque">0</span>
                            </li>
                           <li style="font-size:0.68em;color:#FFF;margin-left:2px;display:flex;justify-content: space-between;align-items:center;" class="empresarial_recebidas">
    ...
    <div class="modal fade" id="exampleModalTipoPlanosHistorico" tabindex="-1" aria-labelledby="exampleModalLabelTipoPlanosHistorico" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabelTipoPlanosHistorico">Planos</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
                </button>
            </div>
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-block btn-primary gerar_pdf_corretor_link_historico">Gerar PDF</button>
            </div>
            </div>
        </div>
    </div>
    ...
    <script>
        ...
        $(function(){
                ...
                if($("#tabela_principal_historico").is(":visible")) {
                    $("#tabela_principal_historico").slideUp(1000,function(){
                        $("#tabela_estorno_back_historico").slideDown('slow',function(){
                            $('#title_estorno_back_historico').html("<h4>Estorno Geral</h4>");
            ...
            $("body").on('click','.user_destaque_historico',function(){
                ...
                let mes_historico = $("#mes_historico :selected").val();
                $("#user_historico").val(id);
                console.log(mes_historico);


                $("#corretor_escolhido_historico").val(id);
                $("#footer_user_historico").html(`
                    <button class="btn btn-info btn-block btn-sm criar_pdf_historico" data-id="${id}">PDF Corretora</button>
                    <button class="btn btn-primary btn-block btn-sm criar_pdf_historico_corretor my-1" data-id="${id}">PDF Corretor</button>
                ...
                if($("#mes_historico").val() != "") {
                    let mes = $("#mes_historico").val();
                    $.ajax({
            ...
            $("#mes_folha_historico").on('change',function(){
               ...
               $.ajax({
                   ...
                   success:function(res) {
                        ...
                        //     $(".list_abas").append(`<li id='mes_existe' style='width:740px;margin-left:5px;background-color:#B22222;display:flex;justify-content: space-between;'><span>O Mês ${selectedTextMudou} já esta fechado</span><button class="btn_valores_mes d-flex justify-content-center" style="border:none;font-size:0.8em;background-color:#FF6347;color:#FFF;border-radius:5px;border:1px solid #FFF;" data-mes="${mes}">Criar PDF</button></li>`);
                        // }
                        $("#list_user_historico").css({"height":"238px","max-height":"238px","overflow":"auto"}).html(res.view);
            ...
            $("#escolher_vendedor_historico").on('change',function(){
                ...
                $("#footer_user_historico").html(`
                    <button class="btn btn-info btn-block btn-sm criar_pdf_historico" data-id="${id}">PDF Corretora</button>
                    <button class="btn btn-primary btn-block btn-sm criar_pdf_historico_corretor" data-id="${id}">PDF Corretor</button>
                    <button class="btn btn-danger btn-block btn-sm criar_pdf_estorno_historico">PDF Estorno</button>
                `);
            ...
            $('body').on('keydown', 'input.porcentagem_change', function(event) {
                if (event.key === 'Tab') {
                    var cell = listarcomissaomesdfirente.cell($(this).closest('td'));
                    var cellIndex = cell.index();
                    var rowCount = listarcomissaomesdfirente.rows().count();
                    var colCount = listarcomissaomesdfirente.columns().count();
                    if (cellIndex.row === rowCount - 1) {
                        $(this).blur();
                        event.preventDefault();
                    } else {
                        var nextRowIndex = cellIndex.row + 1;
                        listarcomissaomesdfirente.cell(nextRowIndex, cellIndex.column).nodes().to$().find('input.porcentagem_change').focus();
                    }
                    event.preventDefault();
                }
            });
            ...
            $('body').on('keydown', 'input.comissao_paga_change', function(event) {
                if (event.key === 'Tab') {
                    ...
                    if (cellIndex.row === rowCount - 1) {
                        ...
                        var nextRowIndex = cellIndex.row + 1;
                        listarcomissaomesdfirente.cell(nextRowIndex, cellIndex.column).nodes().to$().find('input.comissao_paga_change').focus();
                    }
                    event.preventDefault();
                }
            });
            ...
            var listarcomissaomesdfirente = $(".listarcomissaomesdiferente").DataTable({
                ...
                columns: [
                    ...
                    },
                    {
                        ...
                        "createdCell": function (td, cellData, rowData, row, col) {
                            $(td).html(`<div>
                                    <i data-plano="${rowData.plano}" id="${cellData}" class="fas fa-arrow-up pagar_comissao_up"></i></div>`)
                        }
                    },
                    {
            ...
            */
            ...
            $(".list_abas li").on('click',function(){
                $('li').removeClass('ativo_menu').addClass('menu-inativo');
                $(this).addClass("ativo_menu").removeClass('menu');
                let id = $(this).attr('data-id');
...
@section('css')
    <style>
        ...
        .ativo_menu {background-color:#000 !important;color:#FFF !important;}
