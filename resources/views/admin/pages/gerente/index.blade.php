               ...
               <section style="flex-basis:47%;margin-right: 1%;">
                   ...
                   <div style="background-color: #123449;margin-top:2px;">
                       ...
                       <ul style="margin:0 0 0 0;padding:0;" id="lista_apto_a_pagar_ul">
                           <li style="display:flex;justify-content: space-between;color:#FFF;" id="listar_individual_apto">
                           ...
                           <li style="display:flex;justify-content: space-between;color:#FFF;" id="listar_coletivo_apto">
                           ...
                           <li style="display:flex;justify-content: space-between;color:#FFF;" id="listar_empresarial_apto">
