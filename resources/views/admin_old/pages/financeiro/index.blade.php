        ...
        $(document).ready(function(){
            ...
            $(".listarempresarial").DataTable({
                ...
                "drawCallback":function(settings) {
                    if(settings.iDraw >= 3 && settings.sTableId == "tabela_empresarial") {
                        ...
                        var api = this.api();
                        total_vidas_empresa = api.column(5).data().reduce(function (a, b) {
                            return intVal(a) + intVal(b);
                        }, 0);
                        total_linhas_empresa = api.column(0).data().count();
                        total_empresa = api.column(6).data().reduce(function (a, b) {
                            return intVal(a) + intVal(b);
                        }, 0);
            ...
            if(url != -1) {
                ...
                if(alvo == "coletivo") {
                    ...
                    window.history.pushState({path:c},'',casm);
            ...
            $("#atrasado_corretor_coletivo").on('click',function(){
                ...
                table.ajax.url("{{ route('contratos.listarEmpresarial.atrasados') }}").load();
