...
@section('content')
        ...
        <div class="col-md-4">
            <div class="info-box bg-info">
                ...
                <div class="info-box-content">
                    ...
                    <span class="info-box-number">Janeiro (Mês Atual)</span>
    ...
    <section class="row">
        ...
        <div class="col-md-5 border border-width-3 border-info rounded" style="height:400px;background-color:rgba(205, 232, 215,0.5);">
            ...
            <div class="d-flex w-75 mx-auto">
                ...
                <div class="d-flex" style="width:150px;align-items: flex-end;align-content: flex-end;height:400px">
                    <div class="d-flex flex-column" style="width:150px;">
                        <p style="display:flex;justify-content: center;margin:0;padding:0;">
                            <img src="{{asset('storage/users/4iGySSimaR7PUlgwMK9UHCQ7CgEmPiTui29D8CCj.png')}}" alt="Default" width="110px" style="border-radius:50%;border:3px solid #d8a200;box-shadow: rgba(0, 0, 0, 0.25) 0px 54px 55px, rgba(0, 0, 0, 0.12) 0px -12px 30px, rgba(0, 0, 0, 0.12) 0px 4px 6px, rgba(0, 0, 0, 0.17) 0px 12px 13px, rgba(0, 0, 0, 0.09) 0px -3px 5px;">
                        </p>
                        <p class="text-center" style="margin:0;padding:0;">R$ 1,77</p>
        ...
        <div class="col-md-7" style="height:400px;max-height:400px;overflow:auto;">
                ...
                <table class="table table-bordered">
                    ...
                    @foreach($users as $u)
                        <tr>
                            ...
                            <td>{{$u->name}}</td>
                            <td><img src="{{$u->image ? asset('storage/'.$u->image) : asset('storage/avatar-default.jpg')}}" alt="{{$u->name}}" width="50px" height="50px"></td>
                            <td>R$ 2.50</td>
                            <td>10</td>
                        </tr>
                    @endforeach
