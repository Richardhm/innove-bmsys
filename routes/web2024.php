...
//            ->first()->valor;
    ...
    /**Teste**/
    Route::get('/ot/orcamento',"App\Http\Controllers\Admin\OrcamentoController@indexTeste")->name('orcamento.index.ot');
    Route::post("/ot/orcamento","App\Http\Controllers\Admin\OrcamentoController@montarOrcamentoTeste")->name('orcamento.montarOrcamento.ot');
    Route::post("/ot/orcamento/administradoras","App\Http\Controllers\Admin\OrcamentoController@montarOrcamentoAdministradorasTeste")->name('orcamento.administradoras.montar.ot');
    Route::post("/ot/orcamento/criarpdf","App\Http\Controllers\Admin\OrcamentoController@criarPDFTest")->name('orcamento.criarpdf.ot');
    Route::post("/ot/orcamento/criarpdf/ambultorial","App\Http\Controllers\Admin\OrcamentoController@criarPDFAmbulatorialTeste")->name('orcamento.criarpdfambulatorial.ot');
    Route::post("/ot/orcamento/criarpdf/empresarial","App\Http\Controllers\Admin\OrcamentoController@criarPDFEmpresarialTeste")->name('orcamento.criarpdfempresarial.ot');
