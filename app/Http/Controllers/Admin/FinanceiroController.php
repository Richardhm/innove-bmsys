...
class FinanceiroController extends Controller
{
    ...
    {
        // $senha = Hash::make('062062123');
        // echo $senha;
        // return;


        // if(ComissoesCorretoresCancelados::count() >= 1) {

        //     $cancelados = ComissoesCorretoresCancelados::groupBy('comissoes_id')->get();
        //     foreach($cancelados as $cc) {

        //         echo $cc->id." - ".$cc->comissoes_id."<br />";
...
//                        }
    ...
    public function storeEmpresarialFinanceiro(Request $request)
    {
        ...
        $dados['desconto_operadora'] = $request->desconto_operadora ?? 0;
        $dados['quantidade_parcelas'] = $request->quantidade_parcelas ?? 0;
...
//                        $user_id = User::where("codigo_vendedor",$cells[0]->getValue())
//                            //->where("tabela_origens_id",2)
//                            ->first()
//                            ->id;
...
//                        $data_boleto = "";
//                        if($cells[20]->getValue() == "ISENÇÃO" || $cells[20]->getValue() == "N/A" || $cells[20]->getValue() == "DESISTIU") {
//                            $data_boleto = $cells[19]->getValue()->format('Y-m-d');
//                        } else {
//                            $data_boleto = $cells[20]->getValue()->format('Y-m-d');
//                        }
...
//                        $valor_adesao = 0;
//
//                        if($cells[27]->getValue() == "ISENTO" || $cells[27]->getValue() == "DESISTIU") {
//                            $valor_adesao = 0;
//                        } else {
//                            $valor_adesao = empty($cells[27]->getValue()) && $cells[27]->getValue() == null ? $cells[27]->getValue() : $cells[27]->getValue();
//                        }
...
//
//                                }
//                                $comissaoVendedor->valor = ($valor_adesao * $c->valor) / 100;
//                                $comissaoVendedor->save();
//                                $comissao_corretor_contagem++;
//                            }
//                        } else {
...
//                                }
//                                $comissaoCorretoraLancadas->valor = ($valor_adesao * $cc->valor) / 100;
//                                $comissaoCorretoraLancadas->save();
//                                $comissoes_corretora_contagem++;
//                            }
//                        }
